...
public class officialls extends JFrame {
	...
	public officialls() {
		...
		image_label1.setIcon(new ImageIcon("src\\resize1.png"));
...
//				String str1=tf4.getText();
				try {
					String filename="C:\\Users\\HP\\Desktop\\Athilekh_docx\\Report.pdf";
					...
					document.add(Image.getInstance("src\\resize1.png"));
